...
import com.ekko.canal_client.util.ConfigUtil;
import com.google.protobuf.InvalidProtocolBufferException;
import com.ekko.canal_client.kafka.KafkaSender;
...
/**
 * @Author Ekko
 * @Date 2021/2/25 上午 08:38
 * @Version 1.0
 * canal 客户端程序与canal服务端建立连接,然后获取canalServer端的binlog日志
 */
...
//                if (size == -1 || size == 0) {
                if ( size == 0) {
                    ...
                    CanalRowData rowData = new CanalRowData(binlogMsgMap);
